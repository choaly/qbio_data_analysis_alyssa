...
#Create a new column in patient_data (ie our own dataframe, not colData(sum_exp)) called "age_category"
...
#get patient barcodes by taking a substring of the sumor sample barcodes
short_maf <- substr(maf_dataframe@clinical.data$Tumor_Sample_Barcode, 1,12)

#create a new column in maf_dataframe with patient barcodes
